      ...
      <div className='min-w-60'>
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'><input className='w-3' value={"Men's Soccer Jersey"} onChange={toggleCategory} type="checkbox" /> Men's Soccer Jerseys </p>
            <p className='flex gap-2'><input className='w-3' value={"Men's All Sport Game Uniform"} onChange={toggleCategory} type="checkbox" /> Men's All Sport Game Uniforms  </p>
            <p className='flex gap-2'><input className='w-3' value={"Men's Hoodies"} onChange={toggleCategory} type="checkbox" /> Men's Hoodies </p>
            <p className='flex gap-2'><input className='w-3' value={"Men's All Sport Game BaseBall Pants & Shirts"} onChange={toggleCategory} type="checkbox" /> Men's All Sport Game BaseBall Pants & Shirts </p>
          </div>
        </div>
